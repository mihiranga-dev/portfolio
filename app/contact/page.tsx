        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-md leading-relaxed">
              ...
              collaborating on Java or React projects.
            </p>
          </div>
          ...
          <div className="space-y-4 pt-4">
            <a
              ...
              className="group flex items-center gap-4 p-4 rounded-2xl border border-slate-200 dark:border-gray-800 bg-white dark:bg-dark/40 hover:border-primary/50 transition-all"
            >
              <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
                <Mail className="w-5 h-5" />
              </div>
              <p className="text-foreground font-medium">hello@mihiranga.dev</p>
            </a>
            <Link
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                required
                placeholder="Name"
                className="w-full p-4 rounded-xl border border-slate-200 dark:border-gray-800 bg-slate-50 dark:bg-gray-900/50 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-sm"
              />
              <input
                name="email"
                type="email"
            ...
            <textarea
              ...
              className="w-full p-4 rounded-xl border border-slate-200 dark:border-gray-800 bg-slate-50 dark:bg-gray-900/50 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-sm resize-none"
            ></textarea>
