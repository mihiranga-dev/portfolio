...
export default function Home() {
  const seExperience = journey.filter(
    (item) => item.category === "education" || item.category === "independent",
  );
      ...
      <div className="space-y-8 md:space-y-12">
          ...
          <section className="flex flex-col-reverse md:flex-row items-center justify-between pt-12 md:pt-8 pb-0 gap-12">
            <div className="flex-1 space-y-6 text-center md:text-left">
              ...
              <p className="text-base md:text-lg text-slate-600 dark:text-slate-400 max-w-xl leading-relaxed mx-auto md:mx-0">
                Architecting scalable enterprise systems and high-performance
                applications. I turn complex business logic into seamless
                digital experiences.
              </p>
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-3 rounded-full bg-blue-600 text-white hover:scale-110 transition-transform shadow-lg shadow-blue-500/20"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-3 rounded-full bg-slate-800 dark:bg-slate-700 text-white hover:scale-110 transition-transform shadow-lg shadow-black/20"
                  >
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-8 p-6 md:p-8 rounded-2xl border border-slate-200 dark:border-gray-800 bg-slate-50/50 dark:bg-dark/50 backdrop-blur-sm">
            <div className="text-center">
              <span className="block text-4xl font-extrabold text-foreground hover:scale-110 cursor-default hover:text-primary transition-colors">
                160+
              </span>
              <span className="text-[13px] uppercase tracking-[0.2em] text-slate-500 font-semibold">
                LIVE USERS SERVED
              </span>
            </div>
            <div className="text-center">
        ...
        <section className="pb-8">
          <div className="flex items-center justify-between mb-10">
            ...
            <Link
              href="/projects"
              className="text-sm md:text-base text-primary hover:scale-105 transition-transform font-medium"
            >
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col h-full">
                    {/* Contributed Project Badge */}
                    {project.isContributed && (
                      <div className="mb-3 inline-flex items-center gap-1.5 w-fit px-2.5 py-1 rounded-full text-[10px] font-bold tracking-wide uppercase bg-amber-500/10 text-amber-500 border border-amber-500/20">
                        <Users className="w-3 h-3" />
                        {project.role ?? "Contributed Project"}
                      </div>
                    )}
                    ...
                    <div className="flex flex-wrap gap-2 pt-6">
                      {project.tech.map((t) => (
                        <span
                          key={t}
                          className="px-3 py-1 text-xs font-mono font-medium rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 transition-all duration-300 hover:scale-105 cursor-default shadow-lg shadow-blue-500/10"
                        >
                          {t}
                        </span>
                      ))}
                ...
                <div className="flex flex-1 flex-col gap-1 pt-1">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {item.tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded bg-slate-100 dark:bg-gray-800/50 text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-gray-800 transition-all 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed max-w-md">
                ...
                collaborating on enterprise-level Java or React projects.
              </p>
              ...
              <div className="space-y-4 pt-4">
                <div className="flex items-center gap-4 group">
                  ...
                  <a
                    href="mailto:hello@mihiranga.dev"
